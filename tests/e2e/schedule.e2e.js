...
const text = {
  ...
  WORKSHOPS: {
    TITLE: 'WORKSHOPS',
    ACTIVITY_TITLE: 'An introduction to Elm',
    SPEAKER_NAME: 'Jack Franklin',
    SPEAKER_POSITION: ', Frontend Engineer',
    SPEAKER_COMPANY: ', Thread',
  },
  DAY1: {
    TITLE: 'Day 1',
...
describe('Schedule', () => {
  ...
  describe('tabs section', () => {
    it('should show WORKSHOPS tab as active', () => {
      cy.get(selectors.tabSelector)
        .first()
        .should('have.class', 'active')
        .should('contain', text.WORKSHOPS.TITLE);
    });
