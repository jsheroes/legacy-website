...
@JSHeroes 2017 ✨🚀✨✨
      ...
      <div className="row">
        <div className="central-container">
          <p>
            This conference is a not-for-profit community event run by a team of volunteers from the
            Cluj Javascripters community. 2017 is the first year when this amazing conference is
...
Travel... ✈️🚆🚗
          ...
          <p>
            This also applies for travelling from within the country - Iasi. If you&apos;re from
            Bucharest, we recommend you take BlueAir - so that your seat will actually have some
            space for your legs. If you&apos;re joining from Timisoara or Budapest, the train is a
...
...and Accomodation 🛏️
          ...
          <p>
            ...
            JSHeroes conference (at least from Wednesday afternoon to Saturday morning, but possible
            more days if you wish to visit Cluj-Napoca), you can use our &quot;Adopt a
            JavaScripter&quot; couch-surfing program. We will pair you up with a host that we think
...
Catering 🍲
          ...
          <p>
            ...
            breaks. We definitely don&apos;t want you to run around all hungry and decaffeinated,
            throughout the day, so the lunch and coffee breaks are included in the ticket price. For
            lunch, you can expect a healthy meal with various options. It includes vegetarian, vegan
...
Code of Conduct
            ...
            expect cooperation from all of you to help ensure a safe environment for everybody.
          </p>
...
Tickets 🎟️
          ...
          <p>
            ...
            full name registered and that your ticket info is correct. You can also easily change
            your ticket details by accessing it directly from your email.
          </p>
          <p>
            We have a few tickets left for your JavaScript friends and colleagues. All the Early
            Birds are sold out but at the moment we still have some Reasonably Early Bird Tickets
            available.
          </p>
...
Keep updated on our latest conference news 🔊
          ...
          <p>
            ...
            event, to let everyone know of all registration details and other relevant information.
          </p>
