module.exports = [
  ...
  {
    name: 'marianna',
    full_name: 'Marianna Etelson',
    position: 'Senior Front-End Engineer',
    company: 'Nielsen Marketing Cloud',
    img: 'marianna.jpg',
    github: 'https://github.com/kiragona',
    description: '<p>Huge fun of web technologies for more than a decade. The recent years working mostly with React-Redux. Passionate about usability experience leveraging modern development practices and standard to build highly interactive and cutting edge web applications.</p>',
  },
];
